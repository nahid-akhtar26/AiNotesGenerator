  ...
  return (
    ...
    >
        ...
        <div className="relative">
                ...
                whileTap={{scale:0.97}} className="ml-2 h-5 w-5 flex items-center justify-center rounded-full bg-white  text-sx font-bold">
                    ➕
                ...
                <AnimatePresence>
               {
                ...
                className="absolute right-0 mt-4 w-64 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white">
                    ...
                    <button onClick={()=>{setShowCredits(false); navigate("/pricing")}} className="w-full py-2 rounded-lg bg-linear-to-br from-white to-gray-200 text-black font-semibold hover:opacity-90">Buy more Creadits</button>
        ...
        <div className="relative">
                  ...
                  <AnimatePresence>
               {
                ...
                className="absolute right-0 mt-4 w-52 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white">
                     ...
                     <MenuItem text="sign out" red onClick={handleSignOut} className="cursor-pointer"/>
...
function MenuItem({onClick,text,red}){
    return(
        <div 
       onClick={onClick} className={`w-full text-left px-5 py-3 text-sm transition-colors rounded-lg cursor-pointer
        ${
